...
class AudioPlayerMessage extends StatefulWidget {
  const AudioPlayerMessage({Key key, this.source}) : super(key: key);
...
class _AudioPlayerMessageState extends State<AudioPlayerMessage> {
  ...
  StreamSubscription<PlayerState> _playerStateChangedSubscription;
  ...
  Widget _controlButtons() {
    return StreamBuilder<bool>(
      ...
      builder: (context, _) {
        ...
        final icon = _audioPlayer.playerState.playing
            ? Icons.pause
